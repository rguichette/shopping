...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between p-2 md:mx-6 relative">
      ...
      <NavButton title="Menu" customFunc={(prevActiveMenu)=>setActiveMenu((prevActiveMenu =>!prevActiveMenu))} color={currentColor} icon={<AiOutlineMenu />} />
...
<TooltipComponent content="Profile" position="BottomeCenter">
  <div className="flex item-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg" onClick={()=>handleClick('userProfile')} >
    ...
    <p>
      ...
      <span className='text-gray-400 fonr-bold ml-1 text-14'>Michael</span>
    </p>
    <MdKeyboardArrowDown/>
  </div>
</TooltipComponent>
